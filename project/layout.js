        ...
        tableRows.forEach((row) => {
            row.addEventListener('click', function () {
                if (!modalOpen) {
                    ...
                    form.innerHTML = 'Change project info.';
        ...
        addButton.addEventListener('click', function () {
            if (!modalOpen) {
                ...
                // form.method = 'POST';
                form.innerHTML = 'Добавить новый проект.';
                for (let i = 0; i < 6; i++) {
                    const input = document.createElement('input');
                    input.type = 'text';
                    input.name = 'inputName' + i;
                    ...
                    if (i == 1) {
                        ...
                        const listOptions = ["Клиент", "Hellow", "World", "d"];
                        ...
                        input.placeholder = 'Собрано';
                    } else if (i == 5) {
                        input.placeholder = 'Отгружено'
                    }
                    if (i !== 2) {
                        form.appendChild(input);
                    }
